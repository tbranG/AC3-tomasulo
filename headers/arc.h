...
void setStation(ReservationStation* station, Instruction inst, ReservationStation* qj = NULL, ReservationStation* qk = NULL);
...
/// @param entry qual entrada do buffer de reordenação está utilizando o registrador
